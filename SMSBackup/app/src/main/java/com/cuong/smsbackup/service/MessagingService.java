...
import com.cuong.smsbackup.receiver.MessagingReceiver;

/**
 * This service is triggered internally only and is used to process incoming SMS and MMS messages
 * that the {@link com.cuong.smsbackup.receiver.MessagingReceiver} passes over. It's
...
public class MessagingService extends IntentService {
    ...
    public static final String ACTION_MY_RECEIVE_SMS = "com.cuong.backupsms.RECEIVE_SMS";
    public static final String ACTION_MY_RECEIVE_MMS = "com.cuong.backupsms.RECEIVE_MMS";
